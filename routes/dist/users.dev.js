...
var Order = require('../models/order'); // Get register 
...
router.get('/profile', function (req, res) {
  // if(res.locals.user) res.redirect('/');
  var checkChange = false; // res.render('login',{
  //     title:'Login'
  // });
  // console.log(req.session.passport.user);

  var profileID = req.session.passport.user;
  User.findOne({
    _id: profileID
  }, function (err, u) {
    if (err) console.log(err);
    Order.find({
      userOrder: u.username
    }, function (err, o) {
      console.log(o);
      res.render('profile', {
        user: u,
...
router.get('/change_password', function (req, res) {
  ...
  var repassword = req.body;
  console.log(repassword); // console.log(req.session.passport.user);

  var profileID = req.session.passport.user;
  User.findOne({
    _id: profileID
  }, function (err, c) {
    if (err) console.log(err); // console.log(c)
...
router.get('/change_email', function (req, res) {
  ...
  // });
  var checkChange = true;
  var reemail = req.body;
  console.log(reemail); // console.log(req.session.passport.user);
...
router.get('/change_name', function (req, res) {
  ...
  var checkChange = true;
  var rename = req.body;
  console.log(rename); // console.log(req.session.passport.user);

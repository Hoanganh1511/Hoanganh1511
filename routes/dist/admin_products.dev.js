...
var isAdmin = auth.isAdmin; //GET Product model

var Product = require('../models/product'); // GET category model


var Category = require('../models/category'); // GET products index
    ...
    Product.findOne({
      ...
      if (p) {
        ...
        Product.findById(id, function (err, p) {
          ...
          p.desc = desc;
          p.size = size;
          p.price = parseFloat(price).toFixed(2), p.category = category;
